    ...
    public static class NewspaperBllIntegrationTestCases
    {
        public static IEnumerable Search
        {
            get
            {
                ...
                (
                    new Newspaper(null, "Search Null", 0, null, "Test", "Test", DateTime.Now.Year, null, null, DateTime.Now),
                    null
                ).Returns(true);

                yield return new TestCaseData
                (
                    new Newspaper(null, "Test One", 0, null, "Test", "Test", DateTime.Now.Year, null, null, DateTime.Now),
                    new SearchRequest<SortOptions, NewspaperSearchOptions>(SortOptions.None, NewspaperSearchOptions.None, null)
                ).Returns(true);

                yield return new TestCaseData
                (
                    new Newspaper(null, "Test Name", 0, null, "Test", "Test", DateTime.Now.Year, null, null, DateTime.Now),
