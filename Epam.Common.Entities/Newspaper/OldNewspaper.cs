...
{
    public class OldNewspaper : AbstractOldNewspaper
    {
        ...
        public OldNewspaper(int? id, string name, int numberOfPages, string annotation, bool deleted, string publisher, 
        ...
        {
            return obj is OldNewspaper newspaper &&
                   Name == newspaper.Name &&
        ...
        {
            return new OldNewspaper(Id, Name, NumberOfPages, Annotation, Deleted, Publisher, PublishingCity, PublishingYear, Issn, Number, Date);
        }
    }
}
